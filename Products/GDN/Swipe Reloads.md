...
Swipe Reloads are transactions in which a cardholder swipes a card and remits cash to load funds into their account at a participating GDN retail location. Swipe Reloads are 
...
In another model, a card issuer (aka issuing processor) integrates to GDN's [Retail Consumption API](https://developer.greendot.com/embedded-finance/docs/overview-3)I.
